...
# TODO ubuntu base will also need to be parametrized eventually, to introduce support for 26.04
@pytest.fixture
...
def test_deploy_stable_revision(juju_vm_model: Juju, requirer_charm: str) -> None:
    ...
    juju_vm_model.deploy(TLS_NAME, channel="1/stable", config=tls_config)
