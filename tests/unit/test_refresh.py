...
class TestEtcdCharmSpecific:
    ...
    def test_is_compatible_same_major_version(self, etcd_charm_specific):
        ...
        assert etcd_charm_specific.is_compatible(
            charm_name="charmed-etcd",
    ...
    @mock.patch('charms.operator_libs_linux.v2.snap.SnapCache')
    @mock.patch.object(EtcdCharmSpecific, '_post_snap_refresh')
    def test_refresh_snap_failure_revision_unchanged(self, mock_post_refresh, mock_snap_cache, etcd_charm_specific):
    ...
    @mock.patch('charms.operator_libs_linux.v2.snap.SnapCache')
    @mock.patch.object(EtcdCharmSpecific, '_post_snap_refresh')
    def test_refresh_snap_failure_revision_changed(self, mock_post_refresh, mock_snap_cache, etcd_charm_specific):
    ...
    def test_post_snap_refresh_health_check_failure(self, mock_health_check, etcd_charm_specific):
        ...
        expected_status = ops.BlockedStatus("Post-refresh health check failed: Health check failed")
    ...
    def test_ensure_application_and_unit_are_healthy_cluster_not_healthy(self, etcd_charm_specific):
    ...
    def test_ensure_application_and_unit_are_healthy_rebuild_in_progress(self, etcd_charm_specific):
    ...
    def test_ensure_application_and_unit_are_healthy_restore_in_progress(self, etcd_charm_specific):
        ...
        etcd_charm_specific._charm.cluster_manager.state = mock.Mock()
        etcd_charm_specific._charm.cluster_manager.state.cluster = mock.Mock()
        etcd_charm_specific._charm.cluster_manager.state.cluster.rebuild_cluster_in_progress = False
...
class TestCharmRefreshIntegration:
    ...
    def test_handle_post_refresh_health_checks_not_in_progress(self, mock_machines, harness):
        ...
        assert mock_refresh_instance.next_unit_allowed_to_refresh is mock_refresh_instance.next_unit_allowed_to_refresh
