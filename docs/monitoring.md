...
```shell
juju relate grafana-agent charmed-etcd
```
...
```shell
Model  Controller  Cloud/Region         Version  SLA          Timestamp
test   dev         localhost/localhost  3.6.4    unsupported  12:33:25Z
...
```shell
Model  Controller  Cloud/Region         Version  SLA          Timestamp
test   dev         localhost/localhost  3.6.4    unsupported  12:36:27Z
...
* **etcdHighNumberOfFailedGRPCRequests (Severity: warning):**
...
* **etcdHighNumberOfFailedGRPCRequests (Severity: critical):**
    * **Description:** Alerts when a high percentage of gRPC requests fail on an etcd instance.
...
* **etcdHighFsyncDurations (Severity: warning):**
...
* **etcdHighFsyncDurations (Severity: critical):**
    * **Description:** Alerts when etcd cluster 99th percentile fsync durations are too high.
